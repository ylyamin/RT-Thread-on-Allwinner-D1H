...
RTOS on RISC-V SoC hobby project

Hi all,

Just, I’d like to share some information about a personal hobby project that I do from time to time.
I successfully build and ran [RT-Thread](https://www.rt-thread.io/) (a small embedded RTOS) on the RISC-V [Allwinner D1H](https://d1.docs.aw-ol.com/en/) SoC.
Experimenting on [ClockworkPi DevTerm R-01](https://www.clockworkpi.com/home-devterm) device and [Sipeed Lichee RV](https://wiki.sipeed.com/hardware/en/lichee/RV/Dock.html) board
...
And with Allwinner D1H my dream has come true ... sort of. Now seems my hobby is reverse engineering Allwinner products.
...
Found [ClockworkPi DevTerm](https://www.clockworkpi.com/home-devterm) Open Source Portable retro-entertainment Terminal. And for this device was offered Allwinner D1H RISC-V SoC. I thought if Linux can run on this chip, then I could definitely implement some bare-metal drivers. 
But in reality, the Allwinner documentation very limited regarding peripherals - there are no examples and no standalone libraries.
...
At one point, I discovered that in the RT-Thread OS there is a HAL layer (Hardware Abstraction Layer) for the D1. This HAL is separated from the OS and is located in one place. A closer look reveals that this HAL quite similar to Linux drivers.
...
I hope someone finds something useful. Maybe someone can help me with USB driver, please.
